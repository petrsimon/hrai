...
const MODAL_HRAI_LESSONS = 'hraiLessons';
...
const openHraiLessons = function () {
    return openModal(MODAL_HRAI_LESSONS);
};
...
const closeHraiLessons = function () {
    return closeModal(MODAL_HRAI_LESSONS);
};
